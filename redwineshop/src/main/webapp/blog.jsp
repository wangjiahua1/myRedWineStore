...
<body>
    ...
    <div id="content" class="site-content bloggrid bloggrid-masonry">
        ...
        <div class="no-container">
            <div class="blog-breadcrumb">
                <div class="container">
                    ...
                    <div class="intro-div">
                        <h1 class="page-title">collumns 3</h1>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <main id="main" class="site-main">
                    ...
                    <div class="masonry">
                        <article class="post thumb-full col-xs-12 col-sm-12 col-md-8 col-lg-8 big-grid-item grid-item">
