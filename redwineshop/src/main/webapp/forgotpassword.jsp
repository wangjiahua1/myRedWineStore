...
<div class="content">
    ...
    <form id="#mainForm1" class="mainForm mainForm1" action="user?method=forgotpassword" method="post">
        <div class="number">
            <a href="##" class="linkABlue">修改密码邮箱</a>
        ...
        <div class="normalInput">
            <input type="text" class="password" name="password" maxlength="16" autocomplete="off" placeholder="修改密码">
            <input type="password" class="password1" name="password" maxlength="16" autocomplete="off" placeholder="修改密码">
        ...
        <input type="submit" class="fullBtnBlue" value="提交修改">
    </form>
