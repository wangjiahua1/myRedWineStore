    ...
    <div id="content" class="site-content content-fullwidth">
        ...
        <div class="no-container">
            <div class="blog-breadcrumb">
                <div class="container">yudshajkkws
            ...
            <main id="main" class="site-main">
                ...
                <div class="inner-content">
                    ...
                    <div class="our-team">
                        ...
                        <div class="break-line"><span><img src="images/assets/break-image.png" alt=""/></span></div>
                        <div class="list-our-team clearfix">
                            <div class="row">
                                <div class="our-team-item col-md-4 col-sm-4">
                                    <div class="thumbs-profile">
                                        <img src="images/placeholder/our-team1.jpg" alt=""/>
                                    ...
                                    <div class="info-profile clearfix">
                                        <h4 class="info-name">LeoNard</h4>
                                        <span class="info-position">Sales Executive</span>
                                    </div>
                                </div>

                                <div class="our-team-item col-md-4 col-sm-4">
                                    <div class="thumbs-profile">
                                        <img src="images/placeholder/our-team2.jpg" alt=""/>
                                        <ul class="social-profile">
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                            <li><a href="#"><i class="fa fa-dribbble"></i></a></li>
                                    ...
                                    <div class="info-profile clearfix">
                                        <h4 class="info-name">Robert Pineda</h4>
                                        <span class="info-position">Sales Executive</span>
                                    </div>
                                </div>
                                ...
                                <div class="our-team-item col-md-4 col-sm-4">
                                    <div class="thumbs-profile">
                                        <img src="images/placeholder/our-team3.jpg" alt=""/>
                                        <ul class="social-profile">
                                            <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                            <li><a href="#"><i class="fa fa-dribbble"></i></a></li>
                                    ...
                                    <div class="info-profile clearfix">
                                        <h4 class="info-name">TuanCle4n</h4>
                                        <span class="info-position">Sales Executive</span>
                                    </div>
                                </div>
                            </div>
