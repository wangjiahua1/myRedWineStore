            ...
            <li class="layui-nav-item" pc>
                <c:if test="${empty sessionScope.user}">
                    ...
                    <%--<dl class="layui-nav-child">--%>
                        ...
                        <%--<dd><a href="javascript:void(0);" data-url="page/user/changePwd.html"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>修改密码</cite></a></dd>--%>
                ...
                <dl class="layui-nav-child">
                    <dd><a href="javascript:void(0);" data-url="page/user/userInfo.html"><i class="iconfont icon-zhanghu" data-icon="icon-zhanghu"></i><cite>个人资料</cite></a></dd>
                    <dd><a href="javascript:void(0);" data-url="page/user/changePwd.html"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>修改密码</cite></a></dd>
