...
<style>
    ...
    .ulColumn2 li{margin-left: -240px;}
...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <form action="redwine?method=addRedwine" id="addForm"  method="post">
            <ul class="ulColumn2">
                <br/>
                <li>
                    <span class="item_name" style="width:120px;">商品名称：</span>
                    <input type="text" class="textbox textbox_295" placeholder="红酒名称..." value=""  id="pname" name="pname"/>
                    <span class="errorTips" style="visibility:hidden;">错误提示信息...</span>
                </li><br/>
                <li>
                    <span class="item_name" style="width:120px;">红酒价格：</span>
                    <input type="text" class="textbox" placeholder="红酒价格..." value=""  id="price" name="price"/>
                    <span class="errorTips" style="visibility:hidden;">错误提示信息...</span>
                </li><br/>
                <li>
                    <span class="item_name" style="width:120px;">红酒颜色：</span>
                    <input type="text" class="textbox" placeholder="红酒颜色..." value=""  id="color" name="color"/>
                    <span class="errorTips" style="visibility:hidden;">错误提示信息...</span>
                </li><br/>
                ...
                <li>
                    <span class="item_name" style="width:120px;">选择大小：</span>
                    <label class="single_selection"><input type="radio" name="color" class="color" value="L" checked="checked"/>L</label>
                    <label class="single_selection"><input type="radio" name="color" class="color" value="S"/>S</label>
                    <label class="single_selection"><input type="radio" name="color" class="color" value="M"/>M</label>
                    <span class="errorTips" style="visibility:hidden;" id="getSizeError">错误提示信息...</span>
                </li><br/>
                <li>
                    <span class="item_name" style="width:120px;">货源是否充足：</span>
                    <label class="single_selection"><input type="radio" name="availability" class="availability" value="Out Stock" checked="checked"/>Out Stock</label>
                    <label class="single_selection"><input type="radio" name="availability" class="availability" value="In Stock"/>In Stock</label>
                    <span class="errorTips" style="visibility:hidden;" id="getavailabilityError">错误提示信息...</span>
                </li><br/>
                <li>
                    <span class="item_name" style="width:120px;">红酒详情:</span>
                    <textarea cols="40" rows="5" name="description">对红酒的描述</textarea>
                </li><br/>
                <li>
                ...
                <li>
                    ...
                    <input type="button" class="link_btn"  data-method="input_submit" id="addredwine" value="确定"/>
                </li>
            </ul>
            <%--<input type="hidden" name="method" value="addRedwine">--%>
        </form>
    </div>
</section>
</body>
<script type="text/javascript" src="layui/layui.js"></script>
<script type="text/javascript" src="js/addwine.js"></script>
</html>